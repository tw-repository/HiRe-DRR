...
| **Text** | Semantic embedding | [BERT-base-uncased](https://huggingface.co/google-bert/bert-base-uncased) | Utterance-level sentiment representation | [Twitter-RoBERTa](https://huggingface.co/cardiffnlp/twitter-roberta-base-sentiment-latest) |
